package com.example.asd.myanimationapplication;
...
public class MainActivity extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		startFadeAnim= (Button) findViewById(R.id.fadeAnimation);
		...
		startFadeAnim.setOnClickListener(this);
		cancelAnim.setOnClickListener(this);
	}

	public void onClick(View v) {
		System.out.print(v.getClass().toString());
		...
		} else if (startFadeAnim.equals(v)) {
			animationView.setBackgroundResource(R.drawable.ic_launcher);
			Animation transformAnimation = AnimationUtils.loadAnimation(this, R.anim.fade_anim);
			animationView.startAnimation(transformAnimation);
